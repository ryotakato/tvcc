...
try 10 'int main() { int i=0; while(i<10) i=i+1; return i; }'
...
try 7 'int main() { int x=3; int y=5; *(&y+2-1)=7; return x; }'
try 5 'int main() { int x=3; return (&x+2)-&x+3; }'
try 1 'int main() { int x=3; int y=5; return &x-&y; }'
try 2 'int main() { int x=3; int y=5; return &x-&y+1; }'
try 8 'int main() { int x, y; x=3; y=5; return x+y; }'
try 8 'int main() { int x=3, y=5; return x+y; }'
try 1 'int main() { int x=3, y=5; int *z = &y; int *a; a = z - 1; return z-a; }'
try 10 'int main() { int x=3, y=5; int *z = &y; int *a = &x; return *a+*z-*a+*z; }'
